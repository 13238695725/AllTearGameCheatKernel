...
void DrawICON(ImVec2 center, float size)
{
    ImDrawList* draw_list = ImGui::GetWindowDrawList();
    draw_list->AddImage(Icon, { center.x - size / 2, center.y - size / 2 }, { center.x + size / 2, center.y + size / 2 });
}
void DrawBJ(ImVec2 center, float sizeX, float sizeY)
{
    ImDrawList* draw_list = ImGui::GetWindowDrawList();
    draw_list->AddImage(BJ, { center.x - sizeX / 2, center.y - sizeY / 2 }, { center.x + sizeX / 2, center.y + sizeY / 2 });
}
/*
